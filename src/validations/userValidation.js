...
const completeProfilePayload = Joi.object({
  ...
  instagram_followers: Joi.number().when('role', {
    is: 'influencer',
    then: Joi.optional(),
    otherwise: Joi.optional(),
  }),
  instagram_avg_likes: Joi.number().when('role', {
    is: 'influencer',
    then: Joi.optional(),
    otherwise: Joi.optional(),
  }),
  instagram_avg_comments: Joi.number().when('role', {
    is: 'influencer',
    then: Joi.optional(),
    otherwise: Joi.optional(),
  }),
  instagram_engagement_rate: Joi.number().when('role', {
    is: 'influencer',
    then: Joi.optional(),
    otherwise: Joi.optional(),
  }),
  follower_tier: Joi.string().when('role', {
    is: 'influencer',
    then: Joi.optional(),
    otherwise: Joi.optional(),
  }),
